...
Grab the latest portable ZIP from the [Releases page](https://github.com/jadirc/PureType/releases). It is fully self-contained — no .NET runtime install needed. Just extract and run.
